...
/**
 * The {@code ClickjackFilter} is discussed at {@link http
 * ://www.owasp.org/index.php/ClickjackFilter_for_Java_EE}.
 * 
 * <pre>
 *  {@code
 *      <filter>
...
public class ClickjackFilter implements Filter {
	...
	/**
	 * Initialize "mode" parameter from web.xml. Valid values are "DENY" and
	 * "SAMEORIGIN". If you leave this parameter out, the default is to use the
	 * DENY mode.
	 * 
	 * @param filterConfig
	 ...
	 * ://blogs.msdn.com/sdl/archive/2009/02/
	 * 05/clickjacking-defense-in-ie8.aspx}.
	 * 
	 * @param request
	 *            The request object.
	 * @param response
	 *            The response object.
	 * @param chain
	 *            Refers to the {@code FilterChain} object to pass control to
	 *            the next {@code Filter}.
	 * @throws IOException
