...
<body>
	<%
		out.println("<a href=\"xss.jsp?name=<script>alert('XSS attacked!')</script>\" >Test XSS(Use IE).Redirect to xss.jsp</a> <br />");
		out.println("<a href=\"target.jsp\">Test CSRF.Redirect to target.jsp</a> <br />");
	%>
	<br />
	<%
	...
	%>
	<form action="token.jsp?csrf=${csrf}" method="POST"
	...
	%>
	<form action="token2.jsp" method="POST">
		<input type="file" name="file" size="50" value="file value" /> <input
